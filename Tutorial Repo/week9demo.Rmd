...
# Section 2:Drug offences_Xinying Xu
...
```{r trend, fig.cap="The trend of offence"}
crime <- read.csv("data/Data_Tables_Criminal_Incidents_Visualisation_Year_Ending_December_2019.csv")
...
```
In this figure\@ref(fig:trend), it's shown the trend of offence over time.
